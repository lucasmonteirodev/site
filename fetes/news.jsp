...
<head>
	...
	<title>News | Graduação, Pós-Graduação e Extensão Online - FETES Nota Máxima no MEC</title>
	<meta name="title" content="News | Graduação, Pós-Graduação e Extensão Online - FETES Nota Máxima no MEC" />
	...
	<meta property="og:title" content="News | Graduação, Pós-Graduação e Extensão Online - FETES Nota Máxima no MEC" />
	...
	<meta name="twitter:title" content="News | Graduação, Pós-Graduação e Extensão Online - FETES Nota Máxima no MEC">
...
<body>
	...
	<section id="hotsite">
		...
		<section id="blog">
			...
			<%@ include file="./includes/blog/read-news.jsp" %> 
	...
	<script type="text/javascript">
		...
		jQuery(document).on('click', '.seta-up', function(event){
