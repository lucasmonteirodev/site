...
// Fechar pelo botão
const $fecharModaisBotao = document.querySelectorAll('.modal .fechar .Icon');
const $fecharModaisBotao02 = document.querySelectorAll('.modal .fecharModal');
Array.from($fecharModaisBotao, el => el.addEventListener('click', () => fecharModais()))
Array.from($fecharModaisBotao02, el => el.addEventListener('click', () => fecharModais()))
